 ...
 * peers
 */
public class WiFiDropDnsServicesList extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listAdapter = new WiFiDevicesAdapter(this.getActivity(),
                ...
                new ArrayList<WiFiDropDnsService>());
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        ((WiFiDropConnectionListener) getActivity()).connectP2p((WiFiDropDnsService) l
                .getItemAtPosition(position));
        ((TextView) v.findViewById(android.R.id.text2)).setText("Connecting");

    }

    public class WiFiDevicesAdapter extends ArrayAdapter<WiFiDropDnsService> {

        private List<WiFiDropDnsService> items;

        public WiFiDevicesAdapter(Context context, int resource,
                int textViewResourceId, List<WiFiDropDnsService> items) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            WiFiDropDnsService service = items.get(position);
            if (service != null) {
