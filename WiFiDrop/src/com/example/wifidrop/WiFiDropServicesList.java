 ...
 * peers
 */
public class WiFiDropServicesList extends ListFragment {

    WiFiDevicesAdapter listAdapter = null;
    
    interface DeviceClickListener {
        public void connectP2p(WiFiDropService wiFiDropService);
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        ((DeviceClickListener) getActivity()).connectP2p((WiFiDropService) l
                .getItemAtPosition(position));
        ((TextView) v.findViewById(android.R.id.text2)).setText("Connecting");

    }

    public class WiFiDevicesAdapter extends ArrayAdapter<WiFiDropService> {

        private List<WiFiDropService> items;

        public WiFiDevicesAdapter(Context context, int resource,
                int textViewResourceId, List<WiFiDropService> items) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            WiFiDropService service = items.get(position);
            if (service != null) {
